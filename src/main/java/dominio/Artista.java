...
public class Artista implements Serializable {
	...
	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)//mapeamento para criar os id auto
	...
	public String toString() {
		return "Artista [codArtista=" + codArtista + ", nome=" + nome + ", nacionalidade=" + nacionalidade + ", canche="
